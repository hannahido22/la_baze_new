    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-5 sm:py-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-4 border-t border-white/5">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <a href="https://instagram.com/labazerepair" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/40 hover:text-[#E1306C] transition-colors">
          ...
          <a href="https://facebook.com/labazerepair" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/40 hover:text-[#1877F2] transition-colors">
          ...
          <a href="https://wa.me/32493141973" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-white/40 hover:text-[#25d366] transition-colors">
