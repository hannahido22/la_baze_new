...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      ...
      {/* Footer bottom */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-5 sm:py-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-4 border-t border-white/5">
        <div className="font-mono text-[10px] sm:text-xs text-white/40">
          © 2024 La Baze Repair
        </div>

        {/* Social media icons + signature */}
        <div className="flex items-center gap-0.5 sm:gap-1">
          <a href="https://instagram.com/labazerepair" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2 text-white/40 hover:text-[#E1306C] transition-colors">
          ...
          <a href="https://facebook.com/labazerepair" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-2 text-white/40 hover:text-[#1877F2] transition-colors">
          ...
          <a href="https://wa.me/32493141973" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="p-2 text-white/40 hover:text-[#25d366] transition-colors">
          ...
          <span className="w-px h-4 bg-white/10 ml-1.5 sm:ml-2" aria-hidden="true" />
          <img
            src="/signiture.png"
            alt=""
            aria-hidden="true"
            className="h-7 sm:h-9 rounded-lg pointer-events-none select-none opacity-70"
          />
        </div>
